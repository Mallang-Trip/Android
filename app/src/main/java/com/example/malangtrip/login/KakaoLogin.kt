...
import com.example.malangtrip.databinding.BKakaoLoginScreenBinding
...
class KakaoLogin : AppCompatActivity(){
    private lateinit var binding: BKakaoLoginScreenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = BKakaoLoginScreenBinding.inflate(layoutInflater)
